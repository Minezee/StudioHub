...
const Pagination = () => {
  ...
  return (
    <div className="flex items-center justify-center mt-8 gap-2">
      ...
      <button onClick={handleNext} disabled={page < 10 ? false : true} className={`h-8 w-8 flex items-center justify-center rounded ${page < 10 ? "border-primary-color border-[1px] text-white hover:bg-primary-color" : "bg-gray-500 text-gray-400"}`}><IoIosArrowForward /></button>
    </div>
  )
}
