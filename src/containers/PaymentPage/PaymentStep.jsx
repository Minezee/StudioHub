...
const Payment = ({ setActiveStep }) => {
  ...
  return (
    <div className='w-full flex-1 mt-24 flex justify-between'>
      <form onSubmit={handleSubmit} className="w-2/5 text-white">
      ...
      <div className="w-1/3 text-h5 font-bold text-white space-y-7">
