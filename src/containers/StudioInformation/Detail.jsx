    ...
    return (
        <div className='bg-card-bg px-14 py-6 rounded-[20px] text-white'>
            <div className="flex items-start justify-between">
                <div>
                    <h2 className="text-orange-500 text-h2 font-semibold">Corner Music Studio</h2>
            ...
            <div className="mt-20 flex justify-between items-center font-bold">
                <p className="text-h3 text-orange-500">Rp 50.000</p>
                <button onClick={() => scrollToSection(orderSection)} className="bg-orange-500 px-[4.25rem] py-4 rounded-lg text-h5">
                    Order Now
                </button>
            </div>
        </div>
