    ...
    return (
        <div className='flex gap-4'>
            ...
            <div className="bg-yellow-400 rounded-[20px] px-6 py-6 flex-1 text-dark">
                <h3 className="text-h2 font-bold">Room Deluxe</h3>
                <p className="text-h5 font-semibold">Recording Room</p>
                ...
                <button className="bg-orange-500 text-dark text-h5 font-bold mt-10 float-right px-16 py-4 rounded-lg">Order Now</button>
            </div>
        </div>
    )
}
